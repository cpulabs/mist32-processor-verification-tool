...
./out/rol.out:     file format elf32-mist32
...
0003022c <T_EXPECT45>:
   3022c:	80 00 00 0f 	*unknown*

00030230 <T_EXPECT46>:
   30230:	80 00 00 1f 	*unknown*
...
000303a4 <T_IMM_EXPECT45>:
   303a4:	80 00 00 0f 	*unknown*

000303a8 <T_IMM_EXPECT46>:
   303a8:	80 00 00 1f 	*unknown*
