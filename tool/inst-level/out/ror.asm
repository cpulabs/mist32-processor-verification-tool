...
./out/ror.out:     file format elf32-mist32
...
00030190 <T_EXPECT6>:
   30190:	80 00 00 00 	*unknown*

00030194 <T_EXPECT7>:
   30194:	40 00 00 00 	*unknown*

00030198 <T_EXPECT8>:
   30198:	10 00 00 00 	ld8	r0,r0

0003019c <T_EXPECT9>:
   3019c:	01 00 00 00 	mod	r0,r0

000301a0 <T_EXPECT10>:
   301a0:	00 01 00 00 	*unknown*

000301a4 <T_EXPECT11>:
   301a4:	00 00 00 01 	add	r0,r1

000301a8 <T_EXPECT12>:
   301a8:	00 00 00 01 	add	r0,r1

000301ac <T_EXPECT13>:
   301ac:	80 00 00 00 	*unknown*

000301b0 <T_EXPECT14>:
   301b0:	20 00 00 00 	nop

000301b4 <T_EXPECT15>:
   301b4:	02 00 00 00 	inc	r0,r0

000301b8 <T_EXPECT16>:
   301b8:	00 02 00 00 	*unknown*

000301bc <T_EXPECT17>:
   301bc:	00 00 00 02 	add	r0,r2
...
000301c8 <T_EXPECT20>:
   301c8:	40 00 00 00 	*unknown*

000301cc <T_EXPECT21>:
   301cc:	04 00 00 00 	*unknown*
...
000301e0 <T_EXPECT26>:
   301e0:	80 00 00 00 	*unknown*

000301e4 <T_EXPECT27>:
   301e4:	08 00 00 00 	shl	r0,r0

000301e8 <T_EXPECT28>:
   301e8:	00 08 00 00 	*unknown*

000301ec <T_EXPECT29>:
   301ec:	00 00 00 08 	add	r0,r8
...
000301fc <T_EXPECT33>:
   301fc:	10 00 00 00 	ld8	r0,r0

00030200 <T_EXPECT34>:
   30200:	00 10 00 00 	add	r0,0

00030204 <T_EXPECT35>:
   30204:	00 00 00 10 	add	r0,r16
...
00030214 <T_EXPECT39>:
   30214:	20 00 00 00 	nop

00030218 <T_EXPECT40>:
   30218:	00 20 00 00 	sub	r0,r0

0003021c <T_EXPECT41>:
   3021c:	00 00 00 20 	add	r1,r0

00030220 <T_EXPECT42>:
   30220:	60 00 00 00 	*unknown*

00030224 <T_EXPECT43>:
   30224:	0e 00 00 00 	revb	r0,r0

00030228 <T_EXPECT44>:
   30228:	00 1e 00 00 	*unknown*

0003022c <T_EXPECT45>:
   3022c:	00 00 00 3e 	add	r1,rbase

00030230 <T_EXPECT46>:
   30230:	00 00 00 7e 	add	r3,rbase
...
00030398 <T_IMM_EXPECT42>:
   30398:	60 00 00 00 	*unknown*

0003039c <T_IMM_EXPECT43>:
   3039c:	0e 00 00 00 	revb	r0,r0

000303a0 <T_IMM_EXPECT44>:
   303a0:	00 1e 00 00 	*unknown*

000303a4 <T_IMM_EXPECT45>:
   303a4:	00 00 00 3e 	add	r1,rbase

000303a8 <T_IMM_EXPECT46>:
   303a8:	00 00 00 7e 	add	r3,rbase
