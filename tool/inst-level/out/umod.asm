...
./out/umod.out:     file format elf32-mist32
...
0000006c <check>:
    ...
    dea0:	00 b0 21 00 	umod	r8,0x100
    ...
    dec8:	00 b0 41 00 	umod	r8,0x200
    ...
    def0:	00 b0 81 00 	umod	r8,0x400
    ...
    e058:	00 b0 21 00 	umod	r8,0x100
    ...
    e080:	00 b0 41 00 	umod	r8,0x200
    ...
    e0a8:	00 b0 81 00 	umod	r8,0x400
    ...
    e210:	00 b0 21 00 	umod	r8,0x100
    ...
    e238:	00 b0 41 00 	umod	r8,0x200
    ...
    e260:	00 b0 81 00 	umod	r8,0x400
    ...
    e3c8:	00 b0 21 00 	umod	r8,0x100
    ...
    e3f0:	00 b0 41 00 	umod	r8,0x200
    ...
    e418:	00 b0 81 00 	umod	r8,0x400
    ...
    e580:	00 b0 21 00 	umod	r8,0x100
    ...
    e5a8:	00 b0 41 00 	umod	r8,0x200
    ...
    e5d0:	00 b0 81 00 	umod	r8,0x400
    ...
    e738:	00 b0 21 00 	umod	r8,0x100
    ...
    e760:	00 b0 41 00 	umod	r8,0x200
    ...
    e788:	00 b0 81 00 	umod	r8,0x400
    ...
    e8f0:	00 b0 21 00 	umod	r8,0x100
    ...
    e918:	00 b0 41 00 	umod	r8,0x200
    ...
    e940:	00 b0 81 00 	umod	r8,0x400
    ...
    eaa8:	00 b0 21 00 	umod	r8,0x100
    ...
    ead0:	00 b0 41 00 	umod	r8,0x200
    ...
    eaf8:	00 b0 81 00 	umod	r8,0x400
    ...
    ec60:	00 b0 21 00 	umod	r8,0x100
    ...
    ec88:	00 b0 41 00 	umod	r8,0x200
    ...
    ecb0:	00 b0 81 00 	umod	r8,0x400
    ...
    ee18:	00 b0 21 00 	umod	r8,0x100
    ...
    ee40:	00 b0 41 00 	umod	r8,0x200
    ...
    ee68:	00 b0 81 00 	umod	r8,0x400
    ...
    efd0:	00 b0 21 00 	umod	r8,0x100
    ...
    eff8:	00 b0 41 00 	umod	r8,0x200
    ...
    f020:	00 b0 81 00 	umod	r8,0x400
    ...
    f188:	00 b0 21 00 	umod	r8,0x100
    ...
    f1b0:	00 b0 41 00 	umod	r8,0x200
    ...
    f1d8:	00 b0 81 00 	umod	r8,0x400
    ...
    f318:	00 b0 3d 1f 	umod	r8,0x1ff
    ...
    f340:	00 b0 7d 1f 	umod	r8,0x3ff
    ...
    f368:	00 b0 fd 1f 	umod	r8,0x7ff
...
0003355c <T_IMM_EXPECT12>:
   3355c:	00 00 00 01 	add	r0,r1

00033560 <T_IMM_EXPECT13>:
   33560:	00 00 00 01 	add	r0,r1

00033564 <T_IMM_EXPECT14>:
   33564:	00 00 00 01 	add	r0,r1

00033568 <T_IMM_EXPECT15>:
   33568:	00 00 00 01 	add	r0,r1

0003356c <T_IMM_EXPECT16>:
   3356c:	00 00 00 01 	add	r0,r1

00033570 <T_IMM_EXPECT17>:
   33570:	00 00 00 01 	add	r0,r1

00033574 <T_IMM_EXPECT18>:
   33574:	00 00 00 01 	add	r0,r1

00033578 <T_IMM_EXPECT19>:
   33578:	00 00 00 01 	add	r0,r1

0003357c <T_IMM_EXPECT20>:
   3357c:	00 00 00 01 	add	r0,r1

00033580 <T_IMM_EXPECT21>:
   33580:	00 00 00 01 	add	r0,r1
...
0003358c <T_IMM_EXPECT24>:
   3358c:	00 00 00 02 	add	r0,r2

00033590 <T_IMM_EXPECT25>:
   33590:	00 00 00 02 	add	r0,r2

00033594 <T_IMM_EXPECT26>:
   33594:	00 00 00 02 	add	r0,r2

00033598 <T_IMM_EXPECT27>:
   33598:	00 00 00 02 	add	r0,r2

0003359c <T_IMM_EXPECT28>:
   3359c:	00 00 00 02 	add	r0,r2

000335a0 <T_IMM_EXPECT29>:
   335a0:	00 00 00 02 	add	r0,r2

000335a4 <T_IMM_EXPECT30>:
   335a4:	00 00 00 02 	add	r0,r2

000335a8 <T_IMM_EXPECT31>:
   335a8:	00 00 00 02 	add	r0,r2

000335ac <T_IMM_EXPECT32>:
   335ac:	00 00 00 02 	add	r0,r2
...
000335bc <T_IMM_EXPECT36>:
   335bc:	00 00 00 04 	add	r0,r4

000335c0 <T_IMM_EXPECT37>:
   335c0:	00 00 00 04 	add	r0,r4

000335c4 <T_IMM_EXPECT38>:
   335c4:	00 00 00 04 	add	r0,r4

000335c8 <T_IMM_EXPECT39>:
   335c8:	00 00 00 04 	add	r0,r4

000335cc <T_IMM_EXPECT40>:
   335cc:	00 00 00 04 	add	r0,r4

000335d0 <T_IMM_EXPECT41>:
   335d0:	00 00 00 04 	add	r0,r4

000335d4 <T_IMM_EXPECT42>:
   335d4:	00 00 00 04 	add	r0,r4

000335d8 <T_IMM_EXPECT43>:
   335d8:	00 00 00 04 	add	r0,r4
...
000335ec <T_IMM_EXPECT48>:
   335ec:	00 00 00 08 	add	r0,r8

000335f0 <T_IMM_EXPECT49>:
   335f0:	00 00 00 08 	add	r0,r8

000335f4 <T_IMM_EXPECT50>:
   335f4:	00 00 00 08 	add	r0,r8

000335f8 <T_IMM_EXPECT51>:
   335f8:	00 00 00 08 	add	r0,r8

000335fc <T_IMM_EXPECT52>:
   335fc:	00 00 00 08 	add	r0,r8

00033600 <T_IMM_EXPECT53>:
   33600:	00 00 00 08 	add	r0,r8

00033604 <T_IMM_EXPECT54>:
   33604:	00 00 00 08 	add	r0,r8
...
0003361c <T_IMM_EXPECT60>:
   3361c:	00 00 00 10 	add	r0,r16

00033620 <T_IMM_EXPECT61>:
   33620:	00 00 00 10 	add	r0,r16

00033624 <T_IMM_EXPECT62>:
   33624:	00 00 00 10 	add	r0,r16

00033628 <T_IMM_EXPECT63>:
   33628:	00 00 00 10 	add	r0,r16

0003362c <T_IMM_EXPECT64>:
   3362c:	00 00 00 10 	add	r0,r16

00033630 <T_IMM_EXPECT65>:
   33630:	00 00 00 10 	add	r0,r16
...
0003364c <T_IMM_EXPECT72>:
   3364c:	00 00 00 20 	add	r1,r0

00033650 <T_IMM_EXPECT73>:
   33650:	00 00 00 20 	add	r1,r0

00033654 <T_IMM_EXPECT74>:
   33654:	00 00 00 20 	add	r1,r0

00033658 <T_IMM_EXPECT75>:
   33658:	00 00 00 20 	add	r1,r0

0003365c <T_IMM_EXPECT76>:
   3365c:	00 00 00 20 	add	r1,r0
...
0003367c <T_IMM_EXPECT84>:
   3367c:	00 00 00 40 	add	r2,r0

00033680 <T_IMM_EXPECT85>:
   33680:	00 00 00 40 	add	r2,r0

00033684 <T_IMM_EXPECT86>:
   33684:	00 00 00 40 	add	r2,r0

00033688 <T_IMM_EXPECT87>:
   33688:	00 00 00 40 	add	r2,r0
...
000336ac <T_IMM_EXPECT96>:
   336ac:	00 00 00 80 	add	r4,r0

000336b0 <T_IMM_EXPECT97>:
   336b0:	00 00 00 80 	add	r4,r0

000336b4 <T_IMM_EXPECT98>:
   336b4:	00 00 00 80 	add	r4,r0
...
000336dc <T_IMM_EXPECT108>:
   336dc:	00 00 01 00 	add	r8,r0

000336e0 <T_IMM_EXPECT109>:
   336e0:	00 00 01 00 	add	r8,r0
